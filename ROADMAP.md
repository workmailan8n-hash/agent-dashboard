...
- [ ] Weather particles outside windows (rain drops, snow flakes, sun rays)
- [ ] Office lighting tint changes with time (warm sunset, cool night, bright day)
- [ ] Agent mood emoji above head (😊😐😤🔥) based on work/idle ratio
