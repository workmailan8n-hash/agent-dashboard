...
import { PER_ROW, STEP_X, PP_L, PP_R, ppBall, IDLE_SPOTS, KITCHEN_WALL_COL, KITCHEN_START_ROW } from './layout.js';
...
function drawDartAnimation(ctx, tick) {
  ...
  const dartPlayer = Object.values(state.agentStates).find(s =>
...
function drawWritingWhiteboard(ctx, cx, cy, pal, t) {
  ...
  if(Math.random()<0.04) PS.emit(cx+14,cy-10-armUp,1,{vx:0,vy:0,spread:1,gravity:0,life:0.6,size:2,color:'#7aa2f7'});
}
...
export {
  px, shd, drawHeadFront, drawHeadBack, drawHeadSide, drawHeadFront34, drawHeadBack34,
  drawWalkS, drawWalking, drawWalkN, drawWalkE, drawWalkW,
  drawWalkSE, drawWalkSW, drawWalkNE, drawWalkNW, drawWalkIdle,
  WALK_DIR_FN, CHAR_DRAW,
  drawSittingDown, drawTypingNormal, drawTypingFurious, drawThinking,
  drawDrinkingDesk, drawSpinningChair, drawCelebrating,
  drawPhone, drawStretching, drawSleeping, drawDrinkingBeer,
  drawAtCoffee, drawAtFridge, drawEating, drawWindowGaze,
  drawHeadphones, drawAirGuitar, drawYoga, drawReading,
  drawDeskNap, drawDeskYawn, drawDoodling, drawPlantCare,
  drawChattingL, drawChattingR, drawArguingL, drawArguingR,
  drawGossipingL, drawGossipingR, drawGaming, drawTreadmill,
  drawBenchPress, drawBoxing, drawCycling, drawLiftingWeights,
  drawPingPongL, drawPingPongR, drawPingPongBall,
  drawAquariumFish, aquariumFish, drawDustMotes, drawFireflies,
  drawDartAnimation, dartAnims,
  drawSmokingBeer, drawPettingCat, drawCleaning,
  drawStandingUp, drawPlayingArcade, drawDrinkingEspresso,
  drawDJing, drawFixingServer, drawWatching3DPrint,
  drawShootingBasket, drawPlayingFoosball, drawUsingTelescope,
  drawKanban, getTimeOfDay, getDailyWeather,
  drawDynamicWindows, drawOfficeLighting, drawWallClock,
  drawTrashCan,
};
