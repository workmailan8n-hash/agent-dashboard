...
import {
  agentsData, agentStates, idleOccupied, doorAnim,
  globalTick, lastTime, startTime, myTasks,
  setGlobalTick, setLastTime,
  adminMode, simsMode, simsSelectedAgent, setSimsSelectedAgent,
  printerActive, trashLevel, trashAgentId,
  setPrinterActive, setTrashLevel, setTrashAgentId,
  clickAnims,
} from './state.js';
...
import {
  drawKanban, drawDynamicWindows, drawDustMotes, drawFireflies,
  drawWallClock, drawTrashCan, drawOfficeLighting,
  drawPingPongBall, drawDartAnimation, drawAquariumFish,
} from './drawChars.js';
import { cat, goose, bowlRefills } from './creatures.js';
