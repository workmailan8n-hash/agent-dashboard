...
// ════════════════════════════════════════════════════════════════
import {
  agentsData, agentStates, adminMode,
  setMyTasks,
} from './state.js';
...
function connect() {
  ...
  ws.onmessage = ({data}) => {
    ...
    if (msg.type==='mytasks_init' || msg.type==='mytasks_update') { setMyTasks(msg.tasks); renderTasks(); }
...
function startPolling() {
  ...
  pollInterval = setInterval(async () => {
    ...
    try {
      ...
      if (data.myTasks) { setMyTasks(data.myTasks); renderTasks(); }
      updateUI();
      const led = document.getElementById('led'), lbl = document.getElementById('conn-label');
